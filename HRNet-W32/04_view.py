#!/usr/bin/env python3
"""
Step 4 (interactive) — eyeball best.pt on sample frames.
...
Usage:
  python 04_view.py                      # every frame in the manifest
  python 04_view.py --match 2022alhu_qm20
  python 04_view.py --unlabeled-only      # skip frames with no GT points
  python 04_view.py --shuffle
"""
