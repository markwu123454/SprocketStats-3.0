#!/usr/bin/env python3
"""
Step 4b (interactive) — pull a YouTube video, run best.pt over it, and scrub
...
Usage:
  python 05_youtube_view.py "https://www.youtube.com/watch?v=XXXX"
  python 05_youtube_view.py URL --start 60 --end 120   # only download/infer that clip
  python 05_youtube_view.py URL --stride 2             # infer every 2nd frame (faster prep)
"""
