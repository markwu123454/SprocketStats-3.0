#!/usr/bin/env python3
"""
Step 5 -- Identification: decide what each region 05_extract.py read actually
...
deliberately concentrated in one file. 02 finds regions, 05 reads them, and
...
bg_std) and hand them down through 05 untouched, purely so this file could
read them. Neither 02 nor 05 ever DID anything with those values themselves
...
Usage
-----
  python pipeline/06_identify.py --match match1 --save
"""
...
#
# These live here, in the semantic layer, rather than in 05: they describe how
