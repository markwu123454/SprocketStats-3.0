#!/usr/bin/env python3
"""
Step 5 (interactive) — pull a YouTube video, run YOLO over it, and scrub
through it with predicted bounding boxes overlaid.

Shares the download cache with HRNet-W32 so re-running on a URL that HRNet
...
Usage:
  python 05_youtube_view.py "https://www.youtube.com/watch?v=XXXX" 05_youtube_view.py "https://www.youtube.com/watch?v=EjF9we707DA"
  python 05_youtube_view.py URL --start 60 --end 120
  python 05_youtube_view.py URL --stride 2 --threshold 0.4
"""
...
# Shared video cache with HRNet-W32 so downloads aren't duplicated
