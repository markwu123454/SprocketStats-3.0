#!/usr/bin/env python3
"""
Step 2 viz (robot variant) — YouTube viewer for single-class robot detector.

Same as 02_youtube_view.py but defaults to the 1-class checkpoint
(robot_detection_1cls/weights/best.pt) and draws all boxes in white/grey
since alliance is unknown at this level.

Shares the yt-dlp download cache with hrnet.

Usage:
  python 02_youtube_view_robot.py "https://www.youtube.com/watch?v=XXXX"
  python 02_youtube_view_robot.py URL --stride 2
"""
